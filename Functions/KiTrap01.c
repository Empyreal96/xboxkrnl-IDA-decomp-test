int __usercall KiTrap01@<eax>(int a1@<eax>, int a2@<edx>, int a3@<ecx>, int a4@<ebx>, int a5@<ebp>, int a6@<edi>, int a7@<esi>, int a8, int a9)
{
  ...
  v11 = a2;
  v10 = a2;
  return CommonDispatchException0Args(a8, a9 & 0xFFFFFEFF);
}
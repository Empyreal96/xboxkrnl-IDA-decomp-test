...
UnwindUp0:
            JUMPOUT(__CS__, *(_DWORD *)(4 * v4 - 2147230392));
            return;
          default:
            break;
        }
    ...
    if ( count >= 4 )
      JUMPOUT(__CS__, *(_DWORD *)(4 * ((unsigned __int8)dst & 3) - 2147230624));
    JUMPOUT(__CS__, *(_DWORD *)(4 * (count - 4) - 2147230376));
  }
  v5 = &src[count - 4];
  v6 = &dst[count - 4];
  if ( !((unsigned __int8)v6 & 3) )
  {
    ...
    if ( count >> 2 >= 8 )
    {
      ...
      JUMPOUT(__CS__, *(_DWORD *)(4 * (count & 3) - 2147229984));
    }
    JUMPOUT(__CS__, *(_DWORD *)(-4 * v7 - 2147230064));
  }
  if ( count < 4 )
  {
    switch ( count )
  ...
  JUMPOUT(__CS__, *(_DWORD *)(4 * ((unsigned __int8)v6 & 3) - 2147230232));
}
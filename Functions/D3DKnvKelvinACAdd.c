int __usercall D3DK::nvKelvinACAdd@<eax>(D3DK::CDevice *pDevice@<esi>, unsigned int dwD3DStage@<edx>, unsigned int a3@<ebx>, D3DK::CDevice *a4@<edi>)
{
  int hr; // ST1C_4
  unsigned int v5; // edx
  ...
  a4->m_AlphaICW[(_DWORD)pDevice] = v5 | (32 << SLOBYTE(kelvinCombinerInputShift[2]));

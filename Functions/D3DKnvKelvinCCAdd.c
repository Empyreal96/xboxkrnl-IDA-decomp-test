int __usercall D3DK::nvKelvinCCAdd@<eax>(D3DK::CDevice *pDevice@<esi>, unsigned int dwD3DStage@<edx>, unsigned int a3@<ebx>, D3DK::CDevice *a4@<edi>)
{
  int hr; // ST20_4
  unsigned int v5; // edx
  ...
  a4->m_ColorICW[(_DWORD)pDevice] = v5 | (32 << SLOBYTE(kelvinCombinerInputShift[2]));

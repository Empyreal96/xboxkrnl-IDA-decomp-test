void __stdcall XGRAPHICS::XGInternalSwizzler<unsigned long>::Swizzle2x1(XGRAPHICS::XGINTERNALSWIZZLE *ps)
{
  ...
  if ( v11 )
  {
    ...
    do
    {
      ...
      if ( v1->uWidth >> 1 )
      {
        ...
        do
        {
          v13[v1->swiz.m_u | v1->swiz.m_v] = *v12;
          ++v12;
          v14 = v16-- == 1;

int __userpurge HalWriteSMBusValue@<eax>(int a1@<edx>, int a2@<ecx>, int *a3@<edi>, int a4@<esi>, char SlaveAddress, char CommandCode, char WriteWordValue, unsigned int DataValue)
{
  int v8; // edx
  int v9; // ecx
  _KTHREAD *v10; // eax
  ...
  HalpKickoffWriteSMBus(SlaveAddress, CommandCode, NumberOfBytes, DataValue);

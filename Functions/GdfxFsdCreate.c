int *__stdcall GdfxFsdCreate(_DEVICE_OBJECT *DeviceObject, _IRP *Irp)
{
  _GDF_VOLUME_EXTENSION *v2; // ebx
  ...
  int v13; // eax
  int v14; // edx
  _GDF_DIRECTORY_ENTRY DirectoryEntry; // [esp+Ch] [ebp-3Ch]
...
LABEL_15:
        ...
        while ( 1 )
        {
          ...
          if ( !GdfxFindOpenChildFcb(v11, &ElementName, &FoundOrNewFcb) )
            break;
          v11 = FoundOrNewFcb;
          if ( !RemainingName.Length )
          {
...
OpenCurrentFcb_0:
        ...
        while ( 1 )
        {
          ...
          v13 = GdfxLookupElementNameInDirectory(v8, (int)v9, v10, v2, Irp, v11, &ElementName, &DirectoryEntry);
          v10 = (int *)v13;
          if ( v13 < 0 )
            break;
          v10 = (int *)GdfxCreateFcb((int)v9, v8, v11, &ElementName, &DirectoryEntry, &FoundOrNewFcb);
          if ( (signed int)v10 < 0 )
            goto LABEL_57;
          if ( CreateFcbCalled_3 )
          {
...
LABEL_56:
        if ( (signed int)v10 >= 0 )
          goto OpenCurrentFcb_0;
LABEL_57:
        if ( !CreateFcbCalled_3 )
          goto CleanupAndExit_27;
LABEL_58:
        GdfxDereferenceFcb(v8, (int)v9, v10, v11);
        goto CleanupAndExit_27;
      }
    }
    ++v11->ReferenceCount;
    v10 = 0;
OpenStartDirectoryFcb_0:
...
InitializeFileObject:
  ...
  v10 = (int *)-1073741202;
CleanupAndExit_27:
  RtlLeaveCriticalSectionAndRegion(v9, (_KEVENT *)&GdfxGlobalMutex);
  LOBYTE(v14) = 0;

int *__stdcall UdfxFsdQueryInformation(_DEVICE_OBJECT *DeviceObject, _IRP *Irp)
{
  _IRP *v2; // esi
  ...
  Fcb = (_UDF_FCB *)FileObject->FsContext;
  if ( Fcb->Flags & 1 && v3->Parameters.Create.Options != 14 )
  {
    v4 = (int *)-1073741811;
    goto CleanupAndExit_33;
  }
...
LABEL_11:
  ...
  UdfxQueryNetworkOpenInformation(FileObject, (_FILE_NETWORK_OPEN_INFORMATION *)v2->UserBuffer);
  v11 = 56;
LABEL_12:
  v8 = v11;
LABEL_13:

int __userpurge UdfxNonCachedReadCompletion@<eax>(int a1@<edx>, int a2@<ecx>, int *a3@<edi>, _DEVICE_OBJECT *DeviceObject, _IRP *Irp, void *Context)
{
  _IRP *v6; // esi
  ...
  if ( v6->IoStatus.Information != v10 )
  {
    RtlAssert(
      ...
      v8,
      (int)v6,
      "Irp->IoStatus.Information == UDF_CD_SECTOR_ALIGN_UP(ReadLength)",
      "d:\\xbox-apr03\\private\\ntos\\udfx\\read.c",
      0x3Du,
      0);
    v9 = FileObject;

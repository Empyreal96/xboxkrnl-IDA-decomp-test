int __fastcall RtlDowncaseUnicodeString(int a1, int a2, _UNICODE_STRING *DestinationString, _UNICODE_STRING *SourceString, char AllocateDestinationString)
{
        ...
        if ( v11 > 0x5Au )
        {
          ...
          v11 = v12
              + *(_WORD *)(2
                         * ((v12 & 0xF)
                          + 4
                          * (unsigned __int8)Nls844UnicodeLowercaseTableLevel2[(unsigned __int8)Nls844UnicodeCaseTableLevel1[(unsigned int)v12 >> 8]

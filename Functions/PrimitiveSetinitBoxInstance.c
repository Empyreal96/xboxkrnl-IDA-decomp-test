void __thiscall PrimitiveSet::initBoxInstance(PrimitiveSet *this, BoxInst *pbox, int idx)
{
  int v3; // ebx
  PrimitiveSet *v4; // esi
  ...
  v21 = this;
  z = v6;
  SetScale(pbox->fWidth, pbox->fLen, z, v5);
  v8 = pbox->fHeight;
  v9 = pbox->fWidth;
  v10 = (int)&v4->aInstRecs[idx].vObjScale;
  *(float *)(v10 + 4) = pbox->fLen;
  *(float *)v10 = v9;
  *(float *)(v10 + 8) = v8;
  *(float *)(v10 + 12) = 1.0;
  SetRotationFromLHQuat((D3DVECTOR4 *)(16 * pbox->idQuat), &v4->aInstRecs[idx].matOffset);
  v4->aInstRecs[v3].matOffset._41 = (double)pbox->tx * 0.004131 - 27.844984;
  v4->aInstRecs[v3].matOffset._42 = (double)pbox->ty * 0.0082520004 - 0.22872899;
  v4->aInstRecs[v3].matOffset._43 = (double)pbox->tz * 0.0044209999 + 0.49708599;
  ...
  v4->aInstRecs[v3].idxVersion = 0;
  v4->aInstRecs[v3].idxPosAnim = pbox->idPosAnim;
  v4->aInstRecs[v3].idxRotAnim = pbox->idRotAnim;

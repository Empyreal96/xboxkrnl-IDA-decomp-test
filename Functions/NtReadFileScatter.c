int __userpurge NtReadFileScatter@<eax>(int a1@<edx>, int a2@<ecx>, int a3@<esi>, void *FileHandle, void *Event, void (__stdcall *ApcRoutine)(void *, _IO_STATUS_BLOCK *, unsigned int), void *ApcContext, _IO_STATUS_BLOCK *IoStatusBlock, _FILE_SEGMENT_ELEMENT *SegmentArray, unsigned int Length, _LARGE_INTEGER *ByteOffset)
{
  int v11; // edx
  int v12; // ST18_4
  int result; // eax
